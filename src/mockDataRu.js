export default [
  {
    ...
    price: "149.99",
    description:
      "Используйте как молотый кофе, так и капсулы k-cup. Различные варианты заваривания: приготовьте графин на 8, 10 или 12 чашек и чашку на 237, 296 или 355 мл (8, 10 или 12 унций).",
    avatarUrl:
